...
def render_disclaimer():
    st.markdown(
        """
<div style="background:#0d1424; border:1px solid #1e293b; border-radius:14px; padding:18px 22px; margin-top:18px;">
    <div style="font-size:10px;color:#f59e0b;font-weight:800;text-transform:uppercase;letter-spacing:1.5px;margin-bottom:8px;">
        Important Disclaimer
    </div>
    <p style="font-size:11.5px;color:#475569;line-height:1.7;margin-bottom:6px;">
        Strategy C Premium signals 由 FerryRichMan Limited 基於量化動力模型生成，<b style="color:#64748b;">僅供參考、不構成投資建議</b>。
        歷史表現不代表未來，杠杆 ETF 投資涉及顯著風險，包括但不限於本金全部損失。
    </p>
    <p style="font-size:11px;color:#374151;line-height:1.7;">
        投資前請諮詢持牌財務顧問。Past performance is not indicative of future results.
    </p>
</div>
        """,
        unsafe_allow_html=True,
